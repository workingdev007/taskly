  ...
  const data = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Selling on Taskly", link: "#" },
        { name: "Buying on Taskly", link: "#" },
      ],
    },
    {
    ...
    {
      headerName: "Move From Taskly",
      links: [
        { name: "Taskly Business", link: "#" },
        { name: "Taskly Pro", link: "#" },
        { name: "Taskly Logo Maker", link: "#" },
        { name: "Taskly Guides", link: "#" },
        { name: "Get Inspired", link: "#" },
        { name: "Taskly Select", link: "#" },
        { name: "ClearVoice", link: "#" },
        { name: "Taskly Workspace", link: "#" },
        { name: "Learn", link: "#" },
